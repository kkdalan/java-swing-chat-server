...
public class ServiceUser {
    ...
    // SQL
    private final String LOGIN = "select UserID, user_account.UserName, Gender, ImageString from `user` join user_account using (UserID) where `user`.UserName=? and `user`.`Password`=? and user_account.`Status`='1'";
